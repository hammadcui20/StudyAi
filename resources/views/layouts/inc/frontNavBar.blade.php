<nav class="navbar navbar-expand-lg navbar-default fixed-top shadow bg-light">
  <div class="container navbar-default ">
     <a class="navbar-brand text_green fw-bold" href="{{url('/')}}">Study AI</a>
     ...
     <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
           ...
           <a class="nav-link text_green  text-uppercase  fw-bold px-3" href="{{url('category')}}"><span>Content</span></a>
           <a class="nav-link text_green text-uppercase  fw-bold px-3" href="{{url('about')}}"><span>About</span></a>
           <a class="nav-link text_green text-uppercase  fw-bold px-3" href="{{url('about')}}"><span>Meetings</span></a>
           <a class="nav-link text_green  text-uppercase  fw-bold px-3" href="{{url('contact')}}"><span>Chatbot</span></a>
           <a class="nav-link text_green  text-uppercase  fw-bold px-3" href="{{url('contact')}}"><span>Records</span></a>

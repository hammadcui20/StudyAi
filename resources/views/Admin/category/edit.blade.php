        ...
        <form method="POST" action="{{url('update-category/'.$category->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control border border-dark" name="title" value="{{$category->name}}">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="">Course</label>
                    <input type="text" class="form-control border border-dark" name="course" value="{{$category->slug}}">
                </div>

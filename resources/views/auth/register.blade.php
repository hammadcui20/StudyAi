    ...
    <div class="card shadow bg-light">
        <div class="card-body">
            <div class="row justify-content-center align-items-center">
                <div class="col-6">
                        <div>
                            <img src="{{ asset('images/1.png') }}" class="img-fluid w-100  rounded shadow" alt="">
                        </div>
                </div>
                <div class="col-6">
                    <h2 class="text-primary fw-bold text-center mb-3">Sign-Up Here.....!</h2>
                                    ...
                                    <div class="row g-3 justify-content-center">
                                        ...
                                        <div class="col-6">
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-primary text-white fw-bold w-100">{{ __('Register') }}</button>
                                            </div>
                                        </div>
                                        <div class="col-12">
